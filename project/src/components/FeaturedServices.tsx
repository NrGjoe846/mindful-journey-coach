...
const features = [
  {
    ...
    price: "$199/session",
    image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2938&auto=format&fit=crop"
  },
  {
    icon: Target,
    ...
    price: "$249/session",
    image: "https://images.unsplash.com/photo-1649972904349-6e44c42644a7?q=80&w=2944&auto=format&fit=crop"
  },
  {
    icon: Users,
